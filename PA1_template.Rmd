...
**The mean steps per day was `r nona.meansteps` and the median was `r nona.mediansteps`.**
...
**The most steps were taken during interval `r moststepinterval`**
...
There were `r are.na ` NA values in steps column of the original data.
...
The mean (`r impna.meansteps`) and median (`r impna.mediansteps `) were the same as in the original data and the histogram is a similar shape. However there are more occurences of the mean total of steps. 
